...
| Renderer integration                                    | `app.integration`, `settings-dialog.integration`, `chat-content-usage`: application shortcuts, streaming updates, usage rendering, and staged Settings save/cancel behavior against a mocked preload bridge                                                                                                     |
