...
| Agent、MCP、Skills 与代码执行   | `agent-runtime`, `langgraph-agent-runtime`, `agent-continuation`, `gateway-mcp-loop`, `mcp-manager`, `mcp-schema`, `tool-retriever`, `skills-management`, `builtin-agent-tools`, `code-executor` |
