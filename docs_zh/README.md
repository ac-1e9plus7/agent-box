...
| 10  | [LangGraph Agent Runtime 重构设计](./langgraph-agent-runtime-design.md) | 渐进式 Agent 状态机抽取、兼容性边界、checkpoint 约束与验证方案                                               | `src/electron/api/gateway.ts`, `src/electron/api/agent-runtime.ts`                 |
