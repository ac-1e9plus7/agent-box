...
export const LEGACY_CHAT_COMPLETIONS_HINT = t(
  'The Chat Completions API remains supported, but OpenAI recommends the Responses API for all new projects. Choose this format only when a compatible provider has not implemented `/v1/responses`.',
)
